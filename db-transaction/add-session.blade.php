        ...
        <h3>Repeat these session times on more days</h3><br>
         <div><strong><b>Repeat Evereday :</b> </strong>
           <label class="checkbox-inline">
            <input class="days"  type="checkbox" name="saturday"  value="6">Sa
          </label>
          <label class="checkbox-inline">
            <input class="days" type="checkbox" name="sunday" value="0">Su
          </label>
          <label class="checkbox-inline">
            <input class="days" type="checkbox" name="monday" value="1">M
          </label>
          <label class="checkbox-inline">
            <input class="days" type="checkbox" name="tuesday" value="2">Tu
          </label>
          <label class="checkbox-inline">
            <input class="days" type="checkbox" name="wednesday" value="3">W
          </label>
          <label class="checkbox-inline">
            <input class="days" type="checkbox" name="thursday" value="4">Th
          </label>
          <label class="checkbox-inline">
            <input class="days" type="checkbox" name="friday" value="5">F
          </label>
          <label class="checkbox-inline">
            <input type="date" name="repeat_date" id="repeat_date">
          </label>
         </div>
       </div>
     </div>
...
function countCertainDays( days, d0, d1 ) {
                ...
                var session = $('#session').text(number_of_session);
                 costPerMin =  hourRate /  60  ;
                  ...
                  var costPerSession = parseInt()subTotal + parseInt()lantumFee +parseInt() vat;
                  var totalSessionPrice = parseFloat(costPerSession) * parseFloat(number_of_session);
