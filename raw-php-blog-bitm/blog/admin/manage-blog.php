                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="view-blog.php?id=<?php echo $blog['id']; ?>" class="btn btn-primary btn-xs" title="View Blog Details">
                                    <span class="glyphicon glyphicon-zoom-in"></span>
                                </a>
                                <?php if($blog['publication_status'] == 1) { ?>
                                <a href="?status=unpublished&id=<?php echo $blog['id']; ?>" class="btn btn-success btn-xs" title="Published">
                                    <span class="glyphicon glyphicon-arrow-up"></span>
                                </a>
                                <?php } else { ?>
                                <a href="?status=published&id=<?php echo $blog['id']; ?>" class="btn btn-warning btn-xs" title="Published">
                                    <span class="glyphicon glyphicon-arrow-up"></span>
                                </a>
                                <?php } ?>
                                <a href="edit-blog.php?id=<?php echo $blog['id']; ?>" class="btn btn-info btn-xs">
