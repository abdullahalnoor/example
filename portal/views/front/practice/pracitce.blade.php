      ...
      <section class="team-page-section section-padding">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <h3 class="text-center">Grow your network of reliable, quality GPs</h3>

                            <div class="section-wrapper text-center ">
                           @foreach($networkGPs as $item)
             ...
             <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="section-wrapper text-center ">
                           @foreach($networkBenefits as $item)
         ...
         <section class="right-choice-section section-padding">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="row">
                             @foreach($practiceManagers as $community)
                        <div class="col-md-4 col-sm-4 text-center text-justify">
                            <div class="news-wrapper">
                                <img src="{{asset($community->image)}}" alt="" class="img-responsive" style="width: 100%">
        ...
        <section class="right-choice-section section-padding">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="row">
                             @foreach($practicePartnerships as $item)
