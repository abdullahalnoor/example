        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Federation Facility Info </h3>
            </div>
            <!-- /.box-header -->
            ...
            @endif
            <!-- form start -->
            <form class="form-horizontal" action="{{url('/admin/new-federation-facility-info')}}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">
