        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add New  Practice Maneger</h3>
            </div>
            <!-- /.box-header -->
            ...
            @endif
            <!-- form start -->
            <form class="form-horizontal" action="{{url('/admin/new-practice-maneger-info')}}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info pull-right">Add Practice Maneger </button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
