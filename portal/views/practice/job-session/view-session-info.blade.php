...
@section('content')
    ...
    <form id="session-info-submit" action="{{url('practice/store-job-session-info')}}" method="POST">
      {{csrf_field()}}
      <div class="row">      
       <div class="col-md-12">
        ...
        <div class="row">
         ...
         <div class="row">
          <div class="col-xs-6">
            ...
            @if ($errors->has('time'))
                <span class="text-danger"><strong>{{ $errors->first('time') }}</strong></span>
                  @endif 
          </div>
          <div class="col-xs-6">
      ...
      <div class="row">
        <div class="col-md-12">
          <a href="{{url('practice/view-job-session')}}"  class="btn btn-warning">Back</a>
          <a href="{{url('practice/store-job-session-info')}}" class="btn btn-success pull-right" onclick="event.preventDefault();
