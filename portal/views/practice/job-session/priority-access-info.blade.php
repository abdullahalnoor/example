...
<section class="content-header">
    ...
    <section class="content">
      ...
      <br>
       ...
       <div class="alert alert-succes">
        <h4>
          <form id="enableAccess" action="{{url('practice/store-job-session-priority-access')}}" method="POST">
            {{csrf_field()}}
      ...
      <div class="row">
        <div class="col-md-12">
          <a href="{{url('practice/view-job-session-info')}}" class="btn btn-warning">Back</a>
          <a href="{{url('practice/store-job-session-priority-access')}}" class="btn btn-success pull-right" onclick="event.preventDefault();
