            ...
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
               ...
               <tr>
                ...
                <tr>
                 <th>Working  Time </th>
                 <td> {{ floor($hours)}} : {{ $minutes}} hours</td>
               </tr>
               <tr>
                 <th>Session Per Cost </th>
                 <td> $ {{ $sessionPerCost}} </td>
               </tr>
              <tr>
              ...
              <tr>
                 <th>Total Cost </th>
                 <td>$ {{ $totalCost == 0 ?$sessionPerCost:$totalCost }} </td>
               </tr>

               <tr>
                 <th>Publication Status</th>
                 <td>{{ $jobSession->status == 1 ?'Published' :'Unpublished'}}</td>
               </tr>
              </table>
            </div>
            <!-- /.box-body -->
